  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-12">
      ...
      <div className="prose prose-sm max-w-none">
        ...
        <p className="mb-4">
          Le site <span className={Avenir.className}>Quinvo</span> est édité et
          publié par Julien Fernandes, entrepreneur individuel exerçant sous le
          statut de micro-entrepreneur (SIRET :
        ...
        <p className="mb-4">
          <span className={Avenir.className}>Quinvo</span> est un service en
          ligne permettant la création et la gestion de factures et de clients.
          Le service est actuellement accessible gratuitement et nécessite la
          création d’un compte utilisateur.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-4">Responsabilité</h2>
        <p className="mb-4">
          <span className={Avenir.className}>Quinvo</span> fournit des outils de
          gestion et de génération de documents à titre informatif. L’éditeur ne
          fournit aucun service comptable, juridique ou fiscal. L’utilisateur
          reste seul responsable de l’exactitude des informations saisies, de
          l’utilisation des documents générés et du respect de ses obligations
          légales et fiscales.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          du service <span className={Avenir.className}>Quinvo</span>.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          L’ensemble des éléments du site{" "}
          <span className={Avenir.className}>Quinvo</span> (textes, interfaces,
          logos, graphismes, fonctionnalités) est protégé par les lois
